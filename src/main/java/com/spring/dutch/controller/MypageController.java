...
public class MypageController {
	...
	public String showMemberData(String mno, Model model, int modifyResult) {
	...
	public String showModify(String mno, Model model) {
...
//		}
	...
	public String memberWithdraw (String mno, RedirectAttributes redirectAttr) {
